...
SYSTEM_PROMPT_PATH = ROOT / "RAG-knowledge-base/prompt/system_prompt.md"
COT_PROMPT_PATH = ROOT / "RAG-knowledge-base/prompt/cot_prompt.md"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--out_dir",
        type=Path,
        default=ROOT / "Results/vl_rag_first100",
    )
